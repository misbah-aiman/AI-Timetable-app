...
const OptionCard = ({ selected, onClick, icon, label, description }: OptionCardProps) => (
  ...
  >
    <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${
      selected ? 'bg-primary-100 dark:bg-primary-900/50 text-primary-500' : 'bg-surface-100 dark:bg-[#18160f] text-gray-400'
    }`}>
      {icon}
    </div>
...
export const OnboardingWizard = () => {
  ...
  return (
    <div className="min-h-screen bg-surface-50 dark:bg-[#18160f] flex items-center justify-center p-4">
        ...
        <Card>
          ...
          {step === 'study' && (
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-center py-6 bg-surface-50 dark:bg-[#18160f] rounded-2xl">
          ...
          {step === 'exercise' && (
            <div className="space-y-5">
              ...
              {!data.exerciseEnabled && (
                <div className="flex items-center gap-3 p-4 bg-surface-100 dark:bg-[#221e15] rounded-2xl">
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 text-sm rounded-2xl border border-primary-100 dark:border-primary-900/30 bg-surface-50 dark:bg-[#221e15] text-gray-900 dark:text-gray-100 placeholder-gray-300 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-transparent"
                />
                <button
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    ...
                    <select value={newClass.day} onChange={e => setNewClass(c => ({ ...c, day: e.target.value }))}
                      className="w-full px-3 py-2.5 text-sm rounded-2xl border border-primary-100 dark:border-primary-900/30 bg-surface-50 dark:bg-[#221e15] text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-transparent"
                    >
                  ...
                  <div>
                    ...
                    <input type="time" value={newClass.endTime}
                      ...
                      className={`w-full px-3 py-2.5 text-sm rounded-2xl border bg-surface-50 dark:bg-[#221e15] text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:border-transparent ${
              ...
              {data.classes.length > 0 && (
                <div className="space-y-2 max-h-44 overflow-y-auto pr-1">
                  ...
                  {data.classes.map((c, i) => (
                    <div key={i} className="flex items-center gap-2 px-3 py-2.5 bg-surface-100 dark:bg-[#18160f] rounded-2xl">
