        ...
        <Card>
          ...
          {step === 'exercise' && (
            <div className="space-y-5">
                        ...
                        <button
                          ...
                          className={`flex-1 py-2.5 rounded-2xl text-sm font-semibold transition-all ${
                            data.exerciseDuration === mins
                              ...
                              : 'bg-surface-100 dark:bg-[#200306] text-gray-500 hover:bg-surface-200 dark:hover:bg-white/[0.07]'
                          }`}
                        >
                          {mins}m
                        </button>
              ...
              {!data.exerciseEnabled && (
                <div className="flex items-center gap-3 p-4 bg-surface-100 dark:bg-[#200306] rounded-2xl">
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 text-sm rounded-2xl border border-primary-100 dark:border-primary-900/30 bg-surface-50 dark:bg-[#200306] text-gray-900 dark:text-gray-100 placeholder-gray-300 dark:placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-transparent"
                />
                <button
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    ...
                    <select value={newClass.day} onChange={e => setNewClass(c => ({ ...c, day: e.target.value }))}
                      className="w-full px-3 py-2.5 text-sm rounded-2xl border border-primary-100 dark:border-primary-900/30 bg-surface-50 dark:bg-[#200306] text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-300 focus:border-transparent"
                    >
                  ...
                  <div>
                    ...
                    <input type="time" value={newClass.endTime}
                      ...
                      className={`w-full px-3 py-2.5 text-sm rounded-2xl border bg-surface-50 dark:bg-[#200306] text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:border-transparent ${
