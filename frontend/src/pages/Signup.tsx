            ...
            {step === 'success' && (
              <div className="flex flex-col items-center gap-5 py-8 animate-bounce-in">
                ...
                <div className="text-center">
                  <p className="font-bold text-gray-900 dark:text-white text-[20px] tracking-tight">Account created!</p>
                  <p className="text-[14px] text-gray-400 mt-1">Setting up your profile…</p>
                </div>
              </div>
            )}
          </div>
